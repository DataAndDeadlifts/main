...
__all__ = ['DEVICE', 'UNK_IDX', 'PAD_IDX', 'BOS_IDX', 'EOS_IDX', 'text_transform', 'list_string_to_list',
           'count_tokens_in_sequence_file', 'build_vocab', 'get_vocab', 'set_vocab_idx', 'TranscriptionDataset',
...
# %% ../../../nbs/05 training.transcription.train.ipynb 7
...
# %% ../../../nbs/05 training.transcription.train.ipynb 18
...
# %% ../../../nbs/05 training.transcription.train.ipynb 21
text_transform = None
...
# %% ../../../nbs/05 training.transcription.train.ipynb 24
...
# %% ../../../nbs/05 training.transcription.train.ipynb 36
...
# %% ../../../nbs/05 training.transcription.train.ipynb 45
def train_epoch(
