# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_breakdown-annotations-to-csv.ipynb.

# %% auto 0
__all__ = ['get_comment_rows', 'get_num_annotations', 'get_annotations_iter', 'write_seqid_annotations',
           'breakdown_annotations_by_seqid']

# %% ../../nbs/02_breakdown-annotations-to-csv.ipynb 3
import pandas as pd
from pathlib import Path
from tqdm.auto import tqdm
import math

# %% ../../nbs/02_breakdown-annotations-to-csv.ipynb 6
...
# %% ../../nbs/02_breakdown-annotations-to-csv.ipynb 8
